...
main( int argc, char* argv[] ){
	...
	std::cout << "max_speed:" << pfc.max_speed << std::endl;
	std::cout << "distance_threshold:" << pfc.distance_threshold << std::endl;
	std::cout << "angle_threshold:" << pfc.angle_threshold << std::endl;
